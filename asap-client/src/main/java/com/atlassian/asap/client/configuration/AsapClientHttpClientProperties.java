...
@Component
@ConfigurationProperties("asap.client.http.client")
public class AsapClientHttpClientProperties {
    ...
    public static class Builder {
        ...
        public AsapClientHttpClientProperties build() {
            AsapClientHttpClientProperties httpClientProperties = new AsapClientHttpClientProperties();
